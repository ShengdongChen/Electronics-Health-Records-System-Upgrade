...
public class APIUserController extends APIController {
    ...
    public Set<UserForm> getUsers () {
        ...
        final Set<UserForm> response = createResponseForms( User.getUsers() );
        return response;
    }
    ...
    public ResponseEntity getUser ( @PathVariable ( "id" ) final String id ) {
        ...
        return null == user ? new ResponseEntity( errorResponse( "No User found for id " + id ), HttpStatus.NOT_FOUND )
                : new ResponseEntity( new UserForm( user ), HttpStatus.OK );
    }
    ...
    private Set<UserForm> createResponseForms ( List<User> users ) {
        final Set<UserForm> userForms = new HashSet<>();
        if ( users != null ) {
