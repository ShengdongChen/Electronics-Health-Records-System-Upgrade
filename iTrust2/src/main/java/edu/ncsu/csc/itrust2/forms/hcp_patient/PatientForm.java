...
public class PatientForm {
    ...
    public PatientForm ( final Patient patient ) {
        ...
        if ( null != patient.getPrescriptionPreference() ) {
            setPrescriptionPreference( patient.getPrescriptionPreference().toString() );
        }

        if ( null != patient.getDefaultPharmacy() ) {
            setDefaultPharmacy( patient.getDefaultPharmacy().getName() );
        }
    ...
    /** The prescription preference of the patient **/
    @NotEmpty
    private String      prescriptionPreference;

    /**
     * The name of the default pharmacy
     */
    ...
    public PatientForm () {
        ...
        prescriptionPreference = ( DrugType.NotSpecified.toString() );
    }
     ...
     */
    public String getPrescriptionPreference () {
     ...
     */
    public void setPrescriptionPreference ( final String prescriptionPreference ) {
    ...
    public void setDefaultPharmacy ( final String pharmacyName ) {
        this.defaultPharmacy = pharmacyName;
    }
