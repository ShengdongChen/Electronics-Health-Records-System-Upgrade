...
public enum TransactionType {
     ...
     * Pharmacy created
     */
    CREATE_PHARMACY ( 3100, "New pharmacy created", false ),

    /**
     * Pharmacy viewed by user
     */
    VIEW_PHARMACY ( 3101, "Pharmacy viewed", false ),
    /**
     * Pharmacy modified by user
     */
    EDIT_PHARMACY ( 3102, "Pharmacy edited", false ),
    /**
     * Pharmacy deleted
     */
    DELETE_PHARMACY ( 503, "Pharmacy deleted", false ),
    /**
     * Patient selects a default pharmacy
     */
    PATIENT_DEFAULT_PHARMACY ( 3303, "Default Pharmacy Selected", true ),

    /**
     * The pharmacist fills a prescription
     */
    PRESCRIPTION_FILLED ( 3402, "Prescription successfully filled", true ),

    /**
     * The pharmacist is unable to fill a prescription
     */
    PRESCRIPTION_CANCELED ( 3403, "Prescription could not be filled", true ),

    /**
     * Prescription sent to patient's default pharmacy
     */
    PRESCRIPTION_SENT_DEFAULT_PHARMACY ( 3501, "Prescription sent to Default Pharmacy", true ),

    /**
     * Prescription sent to pharmacy that HCP picked
     */
    PRESCRIPTION_SENT_HCP_PHARMACY ( 3502, "Prescription sent to the pharmacy that hcp selected", true ),
    /**
     * Prescription cannot be sent by email
     */
    PRESCRIPTION_EMAIL_NOT_SENT ( 3503, "Email could not be sent since patient doesn't have one", true ),
    /**
     * Prescription can be sent by email
     */
    PRESCRIPTION_EMAIL_SENT ( 3504, "Email has been sent to the patient", true );
