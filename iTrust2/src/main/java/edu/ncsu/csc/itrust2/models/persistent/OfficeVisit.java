...
public abstract class OfficeVisit extends DomainObject<OfficeVisit> {
    ...
    /**
     * Method to remove circular references, allowing objects to be serialized
     * without causing StackOverflowErrors
     */
    public void unlinkCircularReferences () {
        User.unlinkCircularReferences( this.getPatient() );
        BasicHealthMetrics.unlinkCircularReferences( this.getBasicHealthMetrics() );
    };
