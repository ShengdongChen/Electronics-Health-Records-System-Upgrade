...
public class Patient extends DomainObject<Patient> implements Serializable {
    ...
    public Patient ( final PatientForm form ) throws ParseException {
        ...
        setPrescriptionPreference( DrugType.parse( form.getPrescriptionPreference() ) );
        ...
        defaultPharmacy = Pharmacy.getByName( form.getDefaultPharmacy() );
    }
    ...
    /**
     * The preferred drug type for prescriptions, (e.g. brand name or generic)
     */
    @Enumerated ( EnumType.STRING )
    private DrugType     prescriptionPreference;

    /**
     * The default pharmacy of the patient. This is where the
     * drugs/prescriptions go
     */
    @ManyToOne
     ...
     *
     * @param defaultPharmacy
     *            the pharmacy to set
     */
    public void setDefaultPharmacy ( final Pharmacy defaultPharmacy ) {
    ...
    /**
     * Get the prescriptionPreference of the patient
     *
     * @return the prescriptionPreference
     */
    public DrugType getPrescriptionPreference () {
        return prescriptionPreference;
    }

    /**
     * Set the prescriptionPreference of the patient
     *
     * @param prescriptionPreference
     *            the prescriptionPreference to set
     */
    public void setPrescriptionPreference ( final DrugType prescriptionPreference ) {
        this.prescriptionPreference = prescriptionPreference;
    }
    ...
    public Set<Patient> getRepresentatives () {
        if ( representativeList == null ) {
            representativeList = new HashSet<>();
        }
    ...
    /**
     * Helper function to remove circular object references that cause
     * StackOverflows during serialization
     *
     * @param p
     *            The pharmacy to remove references from
     * @return The updated pharmacy
     */
    public static Patient unlinkCircularReferences ( Patient p ) {
        p.setRepresentatives( null );
        p.setRepresented( null );
        User.unlinkCircularReferences( p.getSelf() );
        return p;
    }
}
