...
public class Prescription extends DomainObject<Prescription> {
    ...
    /**
     * This is just used to hold the patient data when sending to the frontend
     */
    @Transient
    ...
    public Prescription ( final PrescriptionForm form ) {
        ...
        setStatus( PrescriptionStatus.parse( form.getStatus() ) );
    }
    ...
    public void setPatientModel ( final Patient patientData ) {
    ...
    /**
     * Helper function to remove circular references from the Prescription
     * object
     *
     * @param p
     *            The prescription to return
     * @return The updated Prescription
     */
    public static Prescription unlinkCircularReferences ( final Prescription p ) {
        if ( p != null ) {
            if ( p.getPatient() != null ) {
                p.getPatient().setPharmacy( null );
            }
            if ( p.getPharmacy() != null ) {
                for ( final Prescription pres : p.getPharmacy().getPrescriptions() ) {
                    pres.setPharmacy( null );
                    pres.setPatient( null );
                }
            }
        }
    ...
    public static List<Prescription> unlinkCircularReferences ( final List<Prescription> prescriptions ) {
