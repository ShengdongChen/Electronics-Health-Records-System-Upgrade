...
public class APIDrugTest {
    ...
    public void setup () {
        ...
        for ( final Pharmacy p : Pharmacy.getPharmacies() ) {
    ...
    public void testDrugAPI () throws UnsupportedEncodingException, Exception {
        ...
        form1.setName( "APIDrugTest1" );
        form1.setGenericName( "TEST1" );
        form1.setDescription( "DESC1" );
        form1.setType( "Generic" );

        final DrugForm form2 = new DrugForm();
        form2.setCode( "0000-0000-01" );
        form2.setName( "APIDrugTest2" );
        form2.setGenericName( "APIDrugTest1" );
        form2.setDescription( "Desc2" );
        form2.setType( "Generic" );
