...
public class PatientViewOfficeVisitStepDefs extends CucumberTest {
    ...
    public void HCPExists () {
        ...
        final User patientUser = new User( patientString,
                "$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.", Role.ROLE_PATIENT, 1 );
        patientUser.save();

        final Patient patient = new Patient();
        patient.setFirstName( "Calvin" );
        patient.setSelf( patientUser );
        patient.setLastName( "Wells" );
        patient.setDateOfBirth( LocalDate.now().minusYears( 20 ) ); // 40 years
                                                                    // old
        patient.save();
