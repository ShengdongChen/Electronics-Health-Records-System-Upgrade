...
public class GeneralCheckupTest {
    ...
    public void testGeneralCheckups () throws NumberFormatException, ParseException {
        ...
        drug.setName( "Li2O8" );
        drug.setGenericName( "Li208" );
        drug.save();

        final Pharmacy phar = new Pharmacy();
        phar.setName( "CVS" );
        phar.setAddress( "123 Main St" );
        phar.setState( State.CA );
        phar.setZip( "12321" );
        phar.save();
        ...
        assertEquals( visit.getPrescriptions().get( 0 ).getPharmacy().getName(),
                copy.getPrescriptions().get( 0 ).getPharmacy().getName() );
        ...
        assertEquals( visit.getPrescriptions().get( 0 ).getPharmacy().getName(),
                form.getPrescriptions().get( 0 ).getPharmacy() );
        ...
        assertEquals( visit.getPrescriptions().get( 0 ).getPharmacy().getName(),
                clone.getPrescriptions().get( 0 ).getPharmacy().getName() );
    ...
    public void testGeneralCheckupForm () throws NumberFormatException, ParseException {
        ...
        form.setFirstName( "AliceThirteen" );
        form.setPreferredName( "AliceThirteen" );
        form.setLastName( "Some" );
        form.setEmail( "ywu44@@ncsu.edu" );
        ...
        form.setPrescriptionPreference( DrugType.Generic.getName() );
        form.setSelf( "AliceThirteen" );
        form.setDefaultPharmacy( "CVS" );
        ...
        final PrescriptionForm pres = new PrescriptionForm();
        pres.setDosage( 3 );
        pres.setDrug( drug.getCode() );

        pres.setEndDate( LocalDate.now().plusDays( 10 ).toString() );
        pres.setPatient( "AliceThirteen" );
        Patient.getByName( "AliceThirteen" ).setDefaultPharmacy( phar );
        pres.setStartDate( LocalDate.now().toString() );
        pres.setRenewals( 5 );
        pres.setPharmacy( "CVS" );
        ...
        assertEquals( visit.getPrescriptions().get( 0 ).getPharmacy(),
                ov.getPrescriptions().get( 0 ).getPharmacy().getName() );
    }
