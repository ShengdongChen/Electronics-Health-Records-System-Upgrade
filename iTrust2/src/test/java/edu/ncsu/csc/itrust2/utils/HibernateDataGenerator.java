...
public class HibernateDataGenerator {
    ...
    public static void generateTestFaculties () throws NumberFormatException, ParseException {
        ...
        final Pharmacy pharm = new Pharmacy( "Dr Mario's Pill Palace", "456 Secondary Rd", "56789", "NC" );
        pharm.save();

        aliceUser.setPharmacy( pharm );
        aliceUser.save();

        final User pharmacist = new User( "pharmacist", "$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.",
                Role.ROLE_PHARMACIST, 1, pharm );
        pharmacist.save();
    ...
    public static void generateTestEHR () throws NumberFormatException, ParseException {
        ...
        estus.setGenericName( "Estus Flask" );
        estus.setType( DrugType.BrandName );
        ...
        purpMoss.setGenericName( "Purple Moss" );
        purpMoss.setType( DrugType.Generic );
